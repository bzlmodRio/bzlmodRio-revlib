...
public class DriveTrain extends SubsystemBase {
  ...
  public DriveTrain() {
    m_leftLeader = new CANSparkMax(PortMap.kDrivetrainMotorLeftAPort, CANSparkMaxLowLevel.MotorType.kBrushless);
    m_leftFollower = new CANSparkMax(PortMap.kDrivetrainMotorLeftBPort, CANSparkMaxLowLevel.MotorType.kBrushless);
    m_rightLeader = new CANSparkMax(PortMap.kDrivetrainMotorRightAPort, CANSparkMaxLowLevel.MotorType.kBrushless);
    m_rightFollower = new CANSparkMax(PortMap.kDrivetrainMotorRightBPort, CANSparkMaxLowLevel.MotorType.kBrushless);
    ...
    if(RobotBase.isSimulation()) {
      ...
      SimDeviceSim leftDeviceSim = new SimDeviceSim("SPARK MAX [" + m_leftLeader.getDeviceId() + "]");
      m_leftEncoderPositionSim = leftDeviceSim.getDouble("Position");
      m_leftEncoderVelocitySim = leftDeviceSim.getDouble("Velocity");
      
      SimDeviceSim rightDeviceSim = new SimDeviceSim("SPARK MAX [" + m_rightLeader.getDeviceId() + "]");
