...
DriveTrain::DriveTrain()
    : m_leftMotorA{kDrivetrainMotorLeftAPort,
      ...
      m_leftMotorB{kDrivetrainMotorLeftBPort,
                   rev::CANSparkMax::MotorType::kBrushless},
      m_leftEncoder{m_leftMotorA.GetEncoder(rev::SparkRelativeEncoder::Type::kHallSensor)},
      m_rightMotorA{kDrivetrainMotorRightAPort,
                    rev::CANSparkMax::MotorType::kBrushless},
      m_rightMotorB{kDrivetrainMotorRightBPort,
                    rev::CANSparkMax::MotorType::kBrushless},
      m_rightEncoder{m_rightMotorA.GetEncoder(rev::SparkRelativeEncoder::Type::kHallSensor)}, m_robotDrive{m_leftMotorA,
                                                               m_rightMotorA},
